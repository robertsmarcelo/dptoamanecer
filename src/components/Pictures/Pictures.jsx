        ...
        >
          {areaImages.map((area) => (
            ...
            <iframe width="289" height="513" 
                src="https://www.youtube.com/embed/hKEZjA_2SDA?controles=0" frameborder="0" allow="accelerometer; autoplay; loop; modestbranding; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen>
            </iframe>
      </div>
